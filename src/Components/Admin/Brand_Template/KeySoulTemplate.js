...
import BasicDetail from "./AddTemplate/BasicDetail";
...
export default function KeySoulTemplateEdit() {
  ...
  // Callback function to enable all tabs
            ...
            items={[
              {
                ...
                key: "1",
                children:
                  activeTabKey === "1" ? <BasicDetail onSave={handleSaveBasicDetails} /> : null // Render only if active
              },
              {
                ...
                disabled: !isTabsEnabled // Disable the tab until details are saved
              },
              {
                label: "Programs",
                key: "3",
