                ...
                <Col className="gutter-row" span={24}>
                  <Row gutter={[24, 0]}>
                    ...
                    <Col className="gutter-row" span={12}>
                      <Form.Item
                        name="template_type"
                        label="Brand Template Type"
                        rules={[{ required: true, message: "Brand Template Type is required" }]}>
                        <Select
                          size="large"
                          options={[
                            { label: "Keysoul", value: "key-soul" },
                            { label: "Enaa", value: "enaa" }
                          ]}
                          // showSearch
                          // mode="multiple"
                          allowClear
                          ...
                          placeholder="Select Brand Template Type"
                        />
                      </Form.Item>
                    </Col>
                    <Col className="gutter-row" span={12}>
